package uz.lazycoder.playmarketclone.ui.books.newreleases
...
import uz.lazycoder.playmarketclone.databinding.FragmentBooksNewReleasesBinding

class BooksNewReleasesFragment : Fragment() {

    private lateinit var list: ArrayList<MovieAndBookM>
    private lateinit var liveData: MutableLiveData<Boolean>
    private lateinit var binding: FragmentBooksNewReleasesBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBooksNewReleasesBinding.inflate(inflater, container, false)
        ...
        binding.apply {
            liveData.observe(viewLifecycleOwner, {
                if (it) {
                    ...
                    rvBooksNewReleases.adapter = RvMoviesAndBooksTopAdapter(list)
                }
            })
        }
