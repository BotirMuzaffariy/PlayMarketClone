package uz.lazycoder.playmarketclone.ui.movies.topselling
...
import uz.lazycoder.playmarketclone.databinding.FragmentMoviesTopSellingBinding

class MoviesTopSellingFragment : Fragment() {

    private lateinit var list: ArrayList<MovieAndBookM>
    private lateinit var liveData: MutableLiveData<Boolean>
    private lateinit var binding: FragmentMoviesTopSellingBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMoviesTopSellingBinding.inflate(inflater, container, false)
        ...
        binding.apply {
            liveData.observe(viewLifecycleOwner, {
                if (it) {
                    ...
                    rvMoviesTopSelling.adapter = RvMoviesAndBooksTopAdapter(list)
                }
            })
        }
