package uz.lazycoder.playmarketclone.ui.books.topfree
...
import uz.lazycoder.playmarketclone.databinding.FragmentBooksTopFreeBinding

class BooksTopFreeFragment : Fragment() {

    private lateinit var list: ArrayList<MovieAndBookM>
    private lateinit var liveData: MutableLiveData<Boolean>
    private lateinit var binding: FragmentBooksTopFreeBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentBooksTopFreeBinding.inflate(inflater, container, false)
        ...
        binding.apply {
            liveData.observe(viewLifecycleOwner, {
                if (it) {
                    ...
                    rvBooksTopFree.adapter = RvMoviesAndBooksTopAdapter(list)
                }
            })
        }
